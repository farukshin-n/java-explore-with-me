...
В дополнение к техническому заданию в приложении реализована функция добавления комментариев к событиям. Пулл-реквест можно посмотреть [здесь](https://github.com/farukshin-n/java-explore-with-me/pull/4).
